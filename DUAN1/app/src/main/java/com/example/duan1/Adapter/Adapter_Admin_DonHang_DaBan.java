...
public class Adapter_Admin_DonHang_DaBan extends BaseAdapter {
    ...
    public Adapter_Admin_DonHang_DaBan(Context c, ArrayList<DonHang>list,DonHangDAO donHangDAO){
        this.c = c;
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Adapter_Admin_DonHang_DaBan.ViewOfItem viewOfItem;

        if(view==null){
            viewOfItem = new Adapter_Admin_DonHang_DaBan.ViewOfItem();

...
public class Adapter_Admin_DonHang extends BaseAdapter {
    private Context c;
    private ArrayList<DonHang> list;
    private TaiKhoanDAO taiKhoanDAO;
    private DonHangDAO donHangDAO;
    public Adapter_Admin_DonHang(Context c, ArrayList<DonHang>list,DonHangDAO donHangDAO){
        this.c = c;
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Adapter_Admin_DonHang.ViewOfItem viewOfItem;

        if(view==null){
            viewOfItem = new Adapter_Admin_DonHang.ViewOfItem();
            ...
            viewOfItem = (Adapter_Admin_DonHang.ViewOfItem) view.getTag();
        }
        ...
        viewOfItem.txtGiatri.setText(list.get(position).getGiatri()+"");

...
public class DBHelped extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // trạng thái 0 là chưa bán, 1 là đã bán
        ...
        String dbDonHang = "CREATE TABLE DONHANG(madon integer primary key autoincrement,masp integer references PET(mapet), manguoimua integer references TAIKHOAN(matk),ngaymua text)";
        ...
        db.execSQL("INSERT INTO PET VALUES (3,'Mực',8,'https://firebasestorage.googleapis.com/v0/b/duan1-15f6d.appspot.com/o/image%2F*c62d8a70-f88d-49c0-8adb-a18dcb660f71?alt=media&token=661677f1-4d5e-481a-b5c2-15f28805104f','C07',800000,0)");
        db.execSQL("INSERT INTO PET VALUES (4,'Lu Ly',10, 'https://firebasestorage.googleapis.com/v0/b/duan1-15f6d.appspot.com/o/image%2F*c62d8a70-f88d-49c0-8adb-a18dcb660f71?alt=media&token=661677f1-4d5e-481a-b5c2-15f28805104f','C08',800000,0)");
        db.execSQL("INSERT INTO PET VALUES (5,'Rich',12,'https://firebasestorage.googleapis.com/v0/b/duan1-15f6d.appspot.com/o/image%2F*c62d8a70-f88d-49c0-8adb-a18dcb660f71?alt=media&token=661677f1-4d5e-481a-b5c2-15f28805104f','C02',700000,1)");
        ...
        //
        db.execSQL("INSERT INTO DONHANG VALUES(1,3,3,'19/03/2022'),(2,4,3,'19/03/2022'),(3,5,4,'19/03/2022')");
